...
#define VDP_REMOTESCREEN 0xE0   // Switch remote screen on and off
#define VDP_KEYBOARDDEBUG 0xE1  // Switch keyboard debug on and off
...
#define PLAY_SOUND_PRIORITY \
	3  // Sound driver task priority with 3 (configMAX_PRIORITIES - 1) being the highest, and 0
	   // being the lowest
